      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="p-6 space-y-6 flex-1">
          <div>
            ...
            <p className="text-sm text-gray-500">Ringkasan informasi bisnis dan performa keuangan NetISP</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm space-y-4">
              <div className="flex justify-between items-center">
                <div>
                  <h3 className="font-semibold text-gray-900">Grafik Pendapatan Bulanan</h3>
                  <p className="text-xs text-gray-500">Dalam satuan juta Rupiah (jt)</p>
                </div>
                <select className="text-xs border border-gray-300 rounded-lg px-2.5 py-1 bg-white">
            ...
            <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm space-y-4">
              <div className="flex justify-between items-center">
                <div>
                  <h3 className="font-semibold text-gray-900">Grafik Pertumbuhan Pelanggan Aktif</h3>
          ...
          {/* 2 List Baris (Pelanggan Terbaru & Tagihan Menunggak) */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {/* Pelanggan Terbaru */}
            <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm space-y-4">
              <div className="flex justify-between items-center">
                  ...
                  <div key={c.id} className="py-3 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-gray-500">{c.packageName}</div>
                      </div>
                    </div>
            ...
            <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm space-y-4">
              <div className="flex justify-between items-center">
                <h3 className="font-semibold text-gray-900">Tagihan Belum Dibayar</h3>
                ...
                {MOCK_INVOICES.filter((inv) => inv.status !== 'LUNAS').map((inv) => (
                  <div key={inv.id} className="py-3 flex items-center justify-between">
                    <div>
                      ...
                      <div className="text-xs text-gray-500">{inv.invoiceNumber} • Periode {inv.period}</div>
                    </div>
